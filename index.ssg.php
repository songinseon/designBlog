        ...
        <div class="form w-8/12 h-4/5 flex">
          <div class="w-2/4 h-full ">
            ...
            <div class="w-full h-2/4 flex flex-col items-center">
              <div class="flex justify-around w-4/5 text-base relative items-center h-2/4">
                <a href="https://codepen.io/songinseon/pen/XWpqjzY?editors=1000" class="relative m4-pr-text">
                  <div>
                    <div>VIEW</div>
                    <div>WIKI</div>
                  </div>
                ...
                <a href="https://www.youtube.com/channel/UCw8uyitepZWa65lG8amfKfQ/videos" class="relative m4-pr-text">
                  <div>
                    <div>VIEW</div>
                    <div>STUDY VLOG</div>
                  </div>
