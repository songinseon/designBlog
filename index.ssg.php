...
<div id="fullpage" class="overflow-y-hidden">
  ...
  <section class="h-screen section w-full" data-anchor="section-2">
    <div class="about-2 container flex items-end w-5/6 mx-auto mb-6">
      ...
      <div class="flex flex-col items-center w-2/4 m2-text1 h-5/6 whitespace-nowrap">
        <div class="about-2-1 flex items-center justify-between w-5/6">
          <div class="ml-2">
            <div class="aboutme_text1">신입</div>
            <div class="aboutme_text1 mb-8">웹디자이너</div>
          </div>
          <div class="mt-8 m2-text1-name ani">송 인 선</div>
          <div class="mt-6 aboutme_text1">입니다.</div>
        </div>

        <div class="w-11/12 m2-text3 about-2-2">
          ...
          <div class="flex flex-col items-center w-full mt-8 m2-text3-character h-3/4">
            ...
            <div class="flex items-center justify-between w-5/6 h-full mt-3">
      ...
      <div class="flex flex-col justify-center items-center w-2/4 m2-text2 h-5/6">
        <div class="flex justify-center w-full about-2-1">
        ...
        <div class="w-11/12 about-2-2">
          <div class="flex flex-col items-center justify-around w-full h-1/4">
            <div class="me-like1"><img src="./img/me-like.png" alt=""></div>
            <div class="mt-5 ml-6 me-like2"><img src="./img/me-like1.png" alt=""></div>
          </div>
  ...
  <section class="h-screen section" data-anchor="section-3">
    <div class="flex items-end justify-center h-full">
      <div class="container mx-auto flex flex-col items-center w-9/12 h-5/6 mb-4">
      ...
      <div class="flex container mx-auto flex-col w-5/6 h-5/6 items-center">
        ...
        <div class="form w-8/12 h-4/5 flex">
          <div class="w-2/4 h-full ">
            ...
            <div class="w-full h-2/4 flex flex-col items-center">
              <div class="flex justify-around w-4/5 text-base relative items-start h-2/4">
                <a href="https://codepen.io/songinseon/full/XWpqjzY" target="_blank" class="relative m4-pr-text">
                  <div>
                    <div>VIEW</div>
                    <div>WIKI</div>
                  </div>
                  <img class="absolute m4-pr-img w-5/6" src="./img/footer-go.png" alt="">
                </a>

                <a href="https://www.youtube.com/channel/UCw8uyitepZWa65lG8amfKfQ/videos" target="_blank" class="relative m4-pr-text">
                  <div>
                    <div>VIEW</div>
                    <div>STUDY VLOG</div>
                  </div>
            ...
            <div class="m4-form h-full w-full items-center justify-center flex">
              ...
              <form class="h-5/6 w-10/12 flex flex-col justify-around" action="https://formspree.io/f/mqkwgrbv"
                ...
                <div class="m4-form-message w-full">
                  <textarea class="w-full h-full p-2" name="message" style="resize: none;"
